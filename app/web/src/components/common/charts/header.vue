<template lang="html">
  <div class="title">
    ...
    <div class="legend-wrapper">
      <ul>
        <li v-for="(legend,index) in legendArr" :key="(legend,index)" v-on:mouseout="donwplay(index)" v-on:mouseover="highlight(index)" :style="styleArr[index]" @click="legendToggle(legend)">
          {{legend.name}}
        </li>
      </ul>
    </div>
